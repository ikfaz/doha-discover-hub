...
const postLoaders: Record<string, () => Promise<ArticleData | null>> = {
  'hamad-international-airport-flight-status-closures-update-2026': async () => (await import('./chunks/posts-chunk-9')).postsChunk9['hamad-international-airport-flight-status-closures-update-2026'] ?? null,
