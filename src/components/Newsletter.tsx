...
const Newsletter = () => {
  ...
  return (
    <div className="bg-primary text-primary-foreground py-16 px-4 sm:px-6 lg:px-8 rounded-lg">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
          <Input
            ...
            className="flex-grow bg-white/10 border-secondary text-white placeholder:text-white/70"
            required
          />
          <Button 
            type="submit"
