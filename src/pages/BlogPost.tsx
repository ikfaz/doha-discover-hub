            ...
            <div className="lg:col-span-2">
              ...
              {slug === 'qatar-work-visa-guide-2025' ? (
                ...
                <div className="prose prose-lg max-w-none space-y-8">
                  ...
                  {/* Rest of content */}
                  <div dangerouslySetInnerHTML={{ __html: '<h2 id="trends">' + post.content.split('<h2 id="trends">')[1] }} />
                </div>
                ...
                <div className="prose prose-lg max-w-none space-y-8">
                  ...
                  {/* Rest of content */}
                  <div dangerouslySetInnerHTML={{ __html: '<h2 id="strategies">' + post.content.split('<h2 id="strategies">')[1] }} />
                </div>
