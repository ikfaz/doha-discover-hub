...
const Blog = () => {
  ...
  const allPosts = [
    ...
    {
      id: '24',
      title: 'The Stars of Tomorrow: FIFA U-17 World Cup Qatar 2026™ Guide',
    ...
    {
      id: '21',
      title: 'A Year of Culture: Katara Cultural Village Events Calendar 2026',
      excerpt: 'Your complete guide to festivals, exhibitions, and performances at Katara Cultural Village throughout 2026 - from dhow festivals to jazz concerts.',
